...
> پلاگین **CynetCore** یک هسته قدرتمند، سبک و مدرن برای سرورهای **Spigot** و **Paper** است که توسط تیم **Cynet** طراحی شده است. تمام نیازهای اساسی سرور خود را در یک پکیج کامل و حرفه‌ای تجربه کنید!

### 🚀 چرا CynetCore؟
- 🛒 **فروشگاه کامل:** سیستم پیشرفته خرید و فروش آیتم با ارز اختصاصی `Ccoin`.
- 🎁 **سیستم پاداش:** دریافت سکه با بازی کردن + ماموریت‌های روزانه (Daily Quests).
- 📢 **پیام‌رسان هوشمند:** برادکست‌های رنگی، خوش‌آمدگویی و اعلان‌های ماموریت.
- 📊 **رابط کاربری:** تب‌لیست (Tab)، اسکوربورد (Sidebar) و اکشن‌بار حرفه‌ای.
- 🛡️ **امنیت:** مدیریت اسپان، ورود امن، جلوگیری از باگ‌های تلپورت و مرگ در وید.
- ⚙️ **تنظیمات کامل:** صفر تا صد پلاگین از طریق `config.yml` قابل شخصی‌سازی است.

### 📦 نصب و راه‌اندازی
1.  فایل `jar` را دانلود کرده و در پوشه `plugins` قرار دهید.
2.  سرور را **Run** کنید تا فایل‌های کانفیگ به صورت خودکار ساخته شوند.
3.  از فایل `config.yml` می‌توانید تمام پیام‌ها و تنظیمات را تغییر دهید.

### 💻 دستورات (Commands)
| دستور | توضیحات |
| :--- | :--- |
| `/sp` | 🛒 باز کردن منوی فروشگاه سرور |
| `/daily` | 📅 مشاهده ماموریت‌های روزانه و وضعیت استریک |
| `/discord` | 💬 دریافت لینک دیسکورد (کپی در کلیپ‌بورد) |
| `/ts` | 🎧 دریافت آی‌پی تیم‌اسپیک (کپی در کلیپ‌بورد) |

### ✨ ویژگی‌های کلیدی

#### 🛒 فروشگاه و اقتصاد (Economy)
*   **دسته‌بندی هوشمند:** تشخیص و دسته‌بندی خودکار بلاک‌ها، ابزارها و...
*   **قیمت‌گذاری:** امکان تعیین ضریب خرید/فروش یا قیمت دستی برای هر آیتم.
*   **رابط کاربری:** خرید و فروش آسان و سریع با کلیک‌های مختلف (چپ/راست/شیفت).

#### 🎯 ماموریت‌ها و استریک
*   **تنوع ماموریت:** شامل بازی کردن، کندن بلاک، کشتن ماب و خرید/فروش.
*   **استریک (Streak):** پاداش ویژه برای ورود متوالی روزانه (رکورد بزنید!).
*   **پاداش آنلاین:** دریافت خودکار `Ccoin` به ازای هر ساعت بازی در سرور.

#### 🎨 ظاهر و گرافیک
*   **Tablist:** نمایش آنلاین‌ها، پینگ، TPS و رم مصرفی سرور.
*   **Scoreboard:** سایدبار داینامیک، زیبا و بدون لگ.
*   **Welcome:** خوش‌آمدگویی جذاب با صدا و تایتل هنگام ورود.
*   **Logo:** نمایش لوگوی اختصاصی سرور در چت.

#### 🔐 امنیت و مدیریت
*   **منوی گیم‌مود:** (قابل غیرفعال‌سازی) برای انتخاب مود بازی پلیرها.
*   **تلپورت امن:** جلوگیری از مرگ در وید (Void) یا گیر کردن در بلاک.
*   **Keep Inventory:** قابلیت نگه‌داشتن آیتم‌ها پس از مرگ (کاملا قابل تنظیم).
